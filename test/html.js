...
describe('HTML formatter', () => {
	...
	const expand = (abbr, profile, options) => {
		...
		return format(replaceVariables(parse(abbr)), profile || new Profile(), 'html', options);
	};
	...
	it('comment', () => {
		...
		assert.equal(expand('ul>li.item', null, { format }), '<ul>\n\t<li class="item"></li>\n\t<!-- /.item -->\n</ul>');
		assert.equal(expand('div>ul>li.item#foo', null, { format }), '<div>\n\t<ul>\n\t\t<li class="item" id="foo"></li>\n\t\t<!-- /#foo.item -->\n\t</ul>\n</div>');
